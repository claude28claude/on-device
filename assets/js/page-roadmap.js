...
const PHASES = [
  ...
  { n: 6,  title: "Text, data, utilities", covers: "QR codes, text workbench, spreadsheets, markdown, zip, checksum, compare.", state: "next" },
  { n: 7,  title: "Extraction",           covers: "PDF text extraction and offline text recognition." },
