...
export default {
  ...
  /* Drawn by JavaScript rather than written into each page. */
  "tool.imagesReady": "{n} तस्वीर तैयार है।",
  "tool.imagesReady.plural": "{n} तस्वीरें तैयार हैं।",
  "pdfTools.preparing": "PDF उपकरण तैयार किए जा रहे हैं। यह एक बार होता है।",
  "pdfTools.ready": "PDF उपकरण तैयार हैं।",
  "queue.state.waiting": "प्रतीक्षा में",
  "queue.state.running": "काम चल रहा है",
  "queue.state.done": "हो गया",
  "queue.state.error": "विफल",
  "queue.state.cancelled": "रद्द किया गया",
  "queue.state.skipped": "छोड़ा गया",
  "queue.progress": "काम चल रहा है — {total} में से {done} पूरी",
  "queue.count": "कतार में {n} फ़ाइल",
  "queue.count.plural": "कतार में {n} फ़ाइलें",
  "queue.stop": "रोकें",
  "queue.skip": "छोड़ें",
  "queue.retry": "फिर कोशिश करें",
  "queue.retryFailed": "{n} विफल फिर से आज़माएँ",
  "queue.stopped": "रोक दिया गया।",

  /* The label on each tool's Run button. */
  "tool.background-remover.run": "पृष्ठभूमि हटाएँ",
  "tool.checksum.run": "चेकसम निकालें",
  "tool.colour-palette.run": "रंग पढ़ें",
  "tool.file-compare.run": "तुलना करें",
  "tool.file-lock.run": "ताला लगाएँ",
  "tool.icon-generator.run": "आइकन बनाएँ",
  "tool.image-blur.run": "चिह्नित हिस्से छिपाएँ",
  "tool.image-combine.run": "जोड़ें",
  "tool.image-compress.run": "छोटा करें",
  "tool.image-convert.run": "बदलें",
  "tool.image-crop.run": "काटें",
  "tool.image-metadata.run": "मेटाडेटा हटाएँ",
  "tool.image-resize.run": "आकार बदलें",
  "tool.image-rotate.run": "घुमाएँ",
  "tool.image-watermark.run": "वॉटरमार्क लगाएँ",
  "tool.images-to-pdf.run": "PDF बनाएँ",
  "tool.markdown.run": "वेब पेज के रूप में सहेजें",
  "tool.pdf-compress.run": "छोटा करें",
  "tool.pdf-extract-text.run": "टेक्स्ट निकालें",
  "tool.pdf-fill-sign.run": "हस्ताक्षरित PDF सहेजें",
  "tool.pdf-flatten.run": "समतल करें",
  "tool.pdf-merge.run": "एक PDF में मिलाएँ",
  "tool.pdf-metadata.run": "बदलाव सहेजें",
  "tool.pdf-nup.run": "सजाएँ",
  "tool.pdf-ocr.run": "टेक्स्ट पढ़ें",
  "tool.pdf-organise.run": "नया क्रम सहेजें",
  "tool.pdf-page-numbers.run": "नंबर जोड़ें",
  "tool.pdf-password-add.run": "सुरक्षित करें",
  "tool.pdf-password-remove.run": "पासवर्ड हटाएँ",
  "tool.pdf-redact.run": "मिटाएँ और नष्ट करें",
  "tool.pdf-rotate-crop.run": "लागू करें",
  "tool.pdf-split.run": "अलग करें",
  "tool.pdf-to-images.run": "पन्ने निर्यात करें",
  "tool.pdf-watermark.run": "वॉटरमार्क जोड़ें",
  "tool.qr-generate.run": "डाउनलोड करें",
  "tool.qr-read.run": "कोड पढ़ें",
  "tool.screenshot-polish.run": "निखारें",
  "tool.spreadsheet.run": "बदलें",
  "tool.text-workbench.run": "टेक्स्ट फ़ाइल के रूप में डाउनलोड करें",
  "tool.zip.run": "ज़िप बनाएँ",
  "tool.runCount.images": "{label} ({n} तस्वीर)",
  "tool.runCount.images.plural": "{label} ({n} तस्वीरें)",
  "tool.runCount.files": "{label} ({n} फ़ाइलें)",
  ...
  "settings.font.hint":
    "अति-सुपाठ्य विकल्प Atkinson Hyperlegible का उपयोग करता है, जिसे ब्रेल इंस्टीट्यूट ने इसलिए बनाया कि मिलते-जुलते अक्षर अलग दिखें। यह साइट के साथ आता है और केवल चुनने पर डाउनलोड होता है।",
