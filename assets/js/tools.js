...
export const TOOLS = [
  ...
  { id: "pdf-metadata",        cat: "pdf",   phase: 4, built: false, icon: "info",        accepts: ["pdf"] },
  { id: "pdf-password-add",    cat: "pdf",   phase: 4, built: false, icon: "lock",        accepts: ["pdf"] },
  { id: "pdf-password-remove", cat: "pdf",   phase: 4, built: false, icon: "unlock",      accepts: ["pdf"] },
  ...
  { id: "pdf-nup",             cat: "pdf",   phase: 4, built: false, icon: "columns",     accepts: ["pdf"] },
